...
class Lab_1_p2_punto3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._f_corte_range = Range(0, 21000, 10, 1500, 200)
        ...
        self.high_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.high_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/cambra05/Descargas/GNURADIO_LABCOMUIS_2022_2_J1B_G1-main/Lab1_P2_ej3_Corregido/gitana_williecolon.wav', True)
