...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "Frecuencia Pulsos fs", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fs_win)
        self._fm_range = Range(0, 10e3, 10, 100, 200)
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecuencia mensaje fm", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fm_win)
        self._DM_range = Range(0, 100, 1, 25, 200)
        self._DM_win = RangeWidget(self._DM_range, self.set_DM, "Retardo demodulador", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DM_win)
        self._D4_range = Range(0, 100, 1, 0, 200)
        self._D4_win = RangeWidget(self._D4_range, self.set_D4, "Retardo 4 D4", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D4_win)
        self._D3_range = Range(0, 100, 1, 75, 200)
        self._D3_win = RangeWidget(self._D3_range, self.set_D3, "Retardo 3 D3", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D3_win)
        self._D2_range = Range(0, 100, 1, 50, 200)
        self._D2_win = RangeWidget(self._D2_range, self.set_D2, "Retardo 2 D2", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D2_win)
        self._D1_range = Range(0, 100, 1, 25, 200)
        self._D1_win = RangeWidget(self._D1_range, self.set_D1, "Retardo 1 D1", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D1_win)
        self._D_range = Range(0, 50, 1, 10, 200)
        self._D_win = RangeWidget(self._D_range, self.set_D, "Ancho pulso D", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(4, samp_rate, fs/4, 100, window.WIN_HANN, 6.76), 1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_delay_0_1 = blocks.delay(gr.sizeof_float*1, D4)
        ...
        self.ModulacionPAM_1 = modulaciondepulsos(
            d=DM,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM_0_0_0 = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM_0_0 = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM_0 = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAM, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.ModulacionPAM, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModulacionPAM_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModulacionPAM_0_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.ModulacionPAM_0_0_0, 0), (self.blocks_delay_0_0_0, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.filter_fft_low_pass_filter_0, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAM, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModulacionPAM_0, 0))
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.ModulacionPAM_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.ModulacionPAM_0_0_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_delay_0_1, 0))
        ...
        self.connect((self.blocks_delay_0_1, 0), (self.ModulacionPAM_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModulacionPAM.set_samp_rate(self.samp_rate)
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, self.fs/4, 100, window.WIN_HANN, 6.76))
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.ModulacionPAM.set_fs(self.fs)
    ...
    def set_DM(self, DM):
        self.DM = DM
        self.ModulacionPAM_1.set_d(self.DM)
    ...
    def set_D4(self, D4):
        self.D4 = D4
        self.blocks_delay_0_1.set_dly(self.D4)
    ...
    def set_D(self, D):
        self.D = D
        self.ModulacionPAM.set_d(self.D)
        self.ModulacionPAM_0.set_d(self.D)
        self.ModulacionPAM_0_0.set_d(self.D)
        self.ModulacionPAM_0_0_0.set_d(self.D)
