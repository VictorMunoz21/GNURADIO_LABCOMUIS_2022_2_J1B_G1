...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Modulacion_0_J1B = Modulacion(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulacion_0_J1B, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.Modulacion_0_J1B, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Modulacion_0_J1B, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulacion_0_J1B, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.Modulacion_0_J1B.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.Modulacion_0_J1B.set_fs(self.fs)
    ...
    def set_D(self, D):
        self.D = D
        self.Modulacion_0_J1B.set_d(self.D)
