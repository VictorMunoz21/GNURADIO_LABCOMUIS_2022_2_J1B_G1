...
# Title: Lab1_punto5_interpolacion
# Author: Mauricio_Ortiz_Victor_Muñoz_J1B_G1
...
class Lab1_punto5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab1_punto5_interpolacion", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_punto5_interpolacion")
