...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "frecuencia dientes de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel ed continua de la señal dientes de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._A_range = Range(-10, 10, 100e-3, 2, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud dientes de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fs, A, DC-A/2, 0)
    ...
    def set_DC(self, DC):
        self.DC = DC
        self.analog_sig_source_x_1.set_offset(self.DC-self.A/2)
