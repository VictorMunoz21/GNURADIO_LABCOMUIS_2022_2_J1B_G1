...
class Lab_1_p2_punto3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab_1_p2_punto3_filtros", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_1_p2_punto3_filtros")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_1_p2_punto3")
        ...
        self.samp_rate = samp_rate = audio_rate*2
        self.fc = fc = 1500
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1000, 300000, 1000, audio_rate*2, 200)
        ...
        self._f_corte_win = RangeWidget(self._f_corte_range, self.set_f_corte, "frecencia de corte", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._f_corte_win)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Escritorio/J1B - Victor&Mauricio/GNURADIO_LABCOMUIS_2022_2_J1B_G1-main/Lab_1_parte2_punto7/gitana_williecolon.wav', True)
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.set_samp_rate(self.audio_rate*2)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Lab_1_p2_punto3, options=None):
