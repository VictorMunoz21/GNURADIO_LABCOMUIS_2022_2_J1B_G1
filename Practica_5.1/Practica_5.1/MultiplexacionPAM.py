...
class MultiplexacionPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "MultiplexacionPAM")
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "Frecuencia de pulso", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, fm, Am, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fm, Am, 0, 0)
        ...
        self.Modulacion_0_2 = Modulacion(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.Modulacion_0_1, 0), (self.blocks_delay_2, 0))
        self.connect((self.Modulacion_0_2, 0), (self.blocks_delay_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulacion_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.Modulacion_0_0, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.Modulacion_0_2, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.Modulacion_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.Modulacion_0_2.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        ...
        self.Modulacion_0_2.set_fs(self.fs)
    ...
    def set_D(self, D):
        ...
        self.Modulacion_0_2.set_d(self.D)
...
def main(top_block_cls=MultiplexacionPAM, options=None):
